...
@:keep class Player2Controlls extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_OnKeyboard_003.property1 = "i";
		_OnKeyboard_003.addOutputs([_ApplyForce_002]);
		_ApplyForce_002.addInput(_OnKeyboard_003, 0);
		_ApplyForce_002.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_OnKeyboard_002.property1 = "k";
		_OnKeyboard_002.addOutputs([_ApplyForce_003]);
		_ApplyForce_003.addInput(_OnKeyboard_002, 0);
		_ApplyForce_003.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		...
		_Gate_004.property0 = "Less Equal";
		...
		_OnKeyboard_005.property1 = ".";
		_OnKeyboard_005.addOutputs([_Gate_004]);
		_Gate_004.addInput(_OnKeyboard_005, 0);
		var _GetDistance_002 = new armory.logicnode.GetDistanceNode(this);
		_GetDistance_002.addInput(new armory.logicnode.ObjectNode(this, "Ball"), 0);
		_GetDistance_002.addInput(new armory.logicnode.ObjectNode(this, ""), 0);
		_GetDistance_002.addOutputs([_Gate_004]);
		_Gate_004.addInput(_GetDistance_002, 0);
		var _Float_006 = new armory.logicnode.FloatNode(this);
		_Float_006.addInput(new armory.logicnode.FloatNode(this, 5.0), 0);
		...
		_OnKeyboard_004.property1 = "h";
		_OnKeyboard_004.addOutputs([_Gate_003]);
		_Gate_003.addInput(_OnKeyboard_004, 0);
		...
		_Gate_003.addInput(_Float_006, 0);
		var _ApplyForce_004 = new armory.logicnode.ApplyForceNode(this);
		_ApplyForce_004.addInput(_Gate_003, 0);
		...
		_VectorMath_003.property0 = "Subtract";
		...
		_GetLocation_004.addOutputs([_VectorMath_003]);
		_VectorMath_003.addInput(_GetLocation_004, 0);
		...
		_GetLocation_002.addOutputs([_VectorMath_003]);
		_VectorMath_003.addInput(_GetLocation_002, 0);
		...
		_VectorMath_005.addInput(new armory.logicnode.VectorNode(this, 1000.0, 1000.0, 1000.0), 0);
		_VectorMath_005.addOutputs([_ApplyForce_004]);
		_VectorMath_005.addOutputs([new armory.logicnode.FloatNode(this, 0.0)]);
		_ApplyForce_004.addInput(_VectorMath_005, 0);
		...
		_Gate_003.addOutputs([_ApplyForce_004]);
		_Gate_003.addOutputs([new armory.logicnode.NullNode(this)]);
		_Float_006.addOutputs([_Gate_004, _Gate_003]);
		_Gate_004.addInput(_Float_006, 0);
		_Gate_004.addOutputs([_ApplyForce_005]);
		_Gate_004.addOutputs([new armory.logicnode.NullNode(this)]);
		_ApplyForce_005.addInput(_Gate_004, 0);
		...
		_VectorMath_007.property0 = "Multiply";
		var _VectorMath_006 = new armory.logicnode.VectorMathNode(this);
		_VectorMath_006.property0 = "Normalize";
		...
		_GetLocation_005.addOutputs([_VectorMath_008]);
		_VectorMath_008.addInput(_GetLocation_005, 0);
		var _VectorMath_009 = new armory.logicnode.VectorMathNode(this);
		_VectorMath_009.property0 = "Subtract";
		...
		_GetLocation_003.addOutputs([_VectorMath_009]);
		_VectorMath_009.addInput(_GetLocation_003, 0);
		_VectorMath_009.addInput(new armory.logicnode.VectorNode(this, 0.0, 0.0, 5.0), 0);
		_VectorMath_009.addOutputs([_VectorMath_008]);
		_VectorMath_009.addOutputs([new armory.logicnode.FloatNode(this, 0.0)]);
		_VectorMath_008.addInput(_VectorMath_009, 0);
		_VectorMath_008.addOutputs([_VectorMath_006]);
		_VectorMath_008.addOutputs([new armory.logicnode.FloatNode(this, 0.0)]);
		_VectorMath_006.addInput(_VectorMath_008, 0);
		_VectorMath_006.addInput(new armory.logicnode.VectorNode(this, 0.5, 0.5, 0.5), 0);
		...
		_VectorMath_007.addInput(new armory.logicnode.VectorNode(this, 600.0, 600.0, 600.0), 0);
		_VectorMath_007.addOutputs([_ApplyForce_005]);
		_VectorMath_007.addOutputs([new armory.logicnode.FloatNode(this, 0.0)]);
		_ApplyForce_005.addInput(_VectorMath_007, 0);
		...
		_OnUpdate_001.addOutputs([new armory.logicnode.NullNode(this)]);
		...
		_OnUpdate_002.addOutputs([_SetRotation]);
		_SetRotation.addInput(_OnUpdate_002, 0);
		...
		_GetLocation_007.addInput(new armory.logicnode.ObjectNode(this, "Ball"), 0);
		_GetLocation_007.addOutputs([_LookingAt]);
		_LookingAt.addInput(_GetLocation_007, 0);
		...
		_SeparateXYZ.name = "SeparateXYZ";
		_SeparateXYZ.watch(true);
		var _VectorMath_001 = new armory.logicnode.VectorMathNode(this);
		_VectorMath_001.property0 = "Normalize";
		...
		_GetLocation_006.addInput(new armory.logicnode.ObjectNode(this, "Ball"), 0);
		_GetLocation_006.addOutputs([_VectorMath_001]);
		_VectorMath_001.addInput(_GetLocation_006, 0);
		_VectorMath_001.addOutputs([_SeparateXYZ]);
		_VectorMath_001.addOutputs([new armory.logicnode.FloatNode(this, 0.0)]);
		_SeparateXYZ.addInput(_VectorMath_001, 0);
